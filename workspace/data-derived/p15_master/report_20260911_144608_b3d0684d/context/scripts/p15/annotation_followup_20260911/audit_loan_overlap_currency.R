...
args<-commandArgs(TRUE);out<-if(length(args))args[1]else"data-derived/p15_source_overlap_currency_20260911_v4"
stopifnot(!dir.exists(out));dir.create(out,recursive=TRUE)
source_path<-file.path(Sys.getenv("P15_LOAN_BASE","data-derived/p15_loan_comparisons_20260910_v5"),"loan_valuations.csv")
