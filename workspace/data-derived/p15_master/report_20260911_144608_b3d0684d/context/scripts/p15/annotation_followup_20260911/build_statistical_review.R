...
out<-if(length(args))args[1] else "data-derived/p15_statistical_annotation_review_20260911_v1"
...
checks<-data.table(check=c("unique_panel_country_year_tier","all_availability_records_cover_seven_years",
 ...
 "reversal_count_19_out_of_209","reversal_case_ids_agree","no_new_benchmark_or_loan_valuation"),
 ...
 nrow(reversal)==209L&&sum(reversal$interest_ranking_reversed)==19L,
