...
out <- if (length(args)) args[[1]] else "data-derived/p15_pv_first_pass_20260909_v1"
...
mapping_path <- file.path(Sys.getenv("P15_DAC_BASE","data-derived/p15_official_dac_mapping_20260908_v1"),"map.csv")
