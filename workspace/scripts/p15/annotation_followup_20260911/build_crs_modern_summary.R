...
out <- if (length(args)) args[1] else file.path("data-derived",paste0("p15_crs_modern_summary_",format(Sys.time(),"%Y%m%d_%H%M%S")))
crs_base <- Sys.getenv("P15_CRS_BASE", p15_current_input("crs_application"))
