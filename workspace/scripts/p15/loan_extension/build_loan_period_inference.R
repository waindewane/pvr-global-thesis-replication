...
out<-if(length(args))args[1] else file.path("data-derived",paste0("p15_loan_period_inference_",format(Sys.time(),"%Y%m%d_%H%M%S")))
stopifnot(!dir.exists(out))
base<-Sys.getenv("P15_LOAN_BASE", p15_current_input("loan_comparisons"))
